...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(rank)|(play)|(logout)|(pay)|(balance)|(sms)|(api)|(gateway)|(code)|(app)|(doll)|(weixin)|(static)|(main)|(DollImage)|(websocket)|(uploadImgs)|(srs)).*";	//不对匹配该值的访问路径拦截（正则）
