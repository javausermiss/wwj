...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="dolltoy/list.do" method="post" name="Form" id="Form">
											...
											<td class="center">
												<div class="hidden-sm hidden-xs btn-group">
														<a class="btn btn-xs btn-success" title="编辑分类" onclick="editToyType('${var.TOY_ID}');">
															<i class="ace-icon fa fa-cog icon-only bigger-110" title="编辑分类"></i>
														</a>
	...
	<script type="text/javascript">
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>dolltoy/goAdd.do';
			 diag.Width = 450;
			 diag.Height = 355;
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>dolltoy/deleteAll.do?tm='+new Date().getTime(),
						    	data: {DATA_IDS:str},
								dataType:'json',
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>dolltoy/excel.do';
		}
	</script>
