            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form action="dolltoy/editToyType.do" name="Form" id="Form" method="post">
                                ...
                                <table id="table_report" class="table table-striped table-bordered table-hover">
                                    <tr>
                                        ...
                                        <td><input type="checkbox" name="TOY_TYPE_ID" value="100001">爆款<br>
                                            <input type="checkbox" name="TOY_TYPE_ID" value="100003">新品<br>
                                            <input type="checkbox" name="TOY_TYPE_ID" value="100004">折扣<br>
                                            <input type="checkbox" name="TOY_TYPE_ID" value="100002">必中<br>
                                        </td>
...
<script type="text/javascript">
    ...
    $(function () {
        window.onload = function () {
            ...
            var checkBoxAll = $("input[name='TOY_TYPE_ID']");
